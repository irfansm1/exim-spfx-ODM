    ...
    var getEmployee = function (props) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    debugger;
                    currentUserLogin = (props.currentSPContext.pageContext._user._displayName == "spfarmadmin") ? "developer3@eximbankindia.in" : props.currentSPContext.pageContext._user._email;
                    return [4 /*yield*/, spCrudOps];
                case 1: return [4 /*yield*/, (_a.sent()).getRootData("EmployeeMaster", "*,Designation/Title,LeaveLevel1/Title,LeaveLevel2/Title,LeaveLevel2/Id,SubGroup/ShortName,CurrentOfficeLocation/Title", "SubGroup,Designation,LeaveLevel1,LeaveLevel2,CurrentOfficeLocation", "(CompanyEmail eq '" + (currentUserLogin) + "')", { column: 'Id', isAscending: false }, props).then(function (results) {
                        //console.log(results);
