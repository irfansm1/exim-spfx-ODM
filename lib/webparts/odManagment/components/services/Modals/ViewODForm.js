...
var ViewODForm = /** @class */ (function (_super) {
    __extends(ViewODForm, _super);
    function ViewODForm(props) {
    ...
    ViewODForm.prototype.componentDidMount = function () {
        var _this = this;
        //this.getEmployeeData();
        //let { ItemID } = useParams();
        var hashUrl = window.location.hash;
        var hashUrlSplit = hashUrl.split('/');
        var ItemID = hashUrlSplit[2];
        //let query = useLocation().search;
        //console.log(query);
        this.setState({ ItemID: ItemID });
        ODMOps().getODRequest(this.props, parseInt(ItemID)).then(function (results) {
    ...
    ViewODForm.prototype.render = function () {
                ...
                React.createElement("div", { className: "row" },
                    ...
                    React.createElement("div", { className: "col-md-6" },
                        React.createElement("div", { className: "form-group" },
                            ...
                            React.createElement(TextField, { disabled: true, readOnly: true, value: this.state.Status })))),
                React.createElement("div", { className: "row" },
                    React.createElement("div", { className: "col-md-6" },
                        React.createElement(Link, { className: "btn btn-danger", to: "/" }, " Close ")),
                    React.createElement("div", { className: "col-md-6" })))));
    };
    return ViewODForm;
}(React.Component));
export default ViewODForm;

//# sourceMappingURL=ViewODForm.js.map
