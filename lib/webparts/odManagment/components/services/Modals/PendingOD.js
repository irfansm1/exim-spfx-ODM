...
var PendingOD = /** @class */ (function (_super) {
    __extends(PendingOD, _super);
    function PendingOD(props) {
                ...
                switch (_a.label) {
                    case 0: return [4 /*yield*/, EmployeeOps().getEmployee(this.props).then(function (brrResults) {
                            if (brrResults) {
                                ...
                                ODMOps().getPendingOD(_this.props, brrResults.Title).then(function (dataReceived) {
    ...
    PendingOD.prototype.componentDidMount = function () {
        this.getEmployeeData();
    };
    PendingOD.prototype.render = function () {
        return (React.createElement("div", { className: "container-fluid" },
            React.createElement("hr", null),
            React.createElement("label", null, this.state.employeeID),
...
export default PendingOD;

//# sourceMappingURL=PendingOD.js.map
