...
var ApprovedOD = /** @class */ (function (_super) {
    __extends(ApprovedOD, _super);
    function ApprovedOD(props) {
                ...
                switch (_a.label) {
                    case 0: return [4 /*yield*/, EmployeeOps().getEmployee(this.props).then(function (brrResults) {
                            if (brrResults) {
                                ...
                                ODMOps().getMyApprovedOD(_this.props, brrResults.Title).then(function (dataReceived) {
    ...
    ApprovedOD.prototype.componentDidMount = function () {
        this.getEmployeeData();
    };
    ApprovedOD.prototype.render = function () {
...
//# sourceMappingURL=ApprovedOD.js.map
