...
var DashboardApproved = /** @class */ (function (_super) {
    __extends(DashboardApproved, _super);
    function DashboardApproved(props) {
    ...
    DashboardApproved.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement("hr", null),
            React.createElement(Fabric, null,
                React.createElement(DetailsList, { columns: this.columns, items: this.props.approvedOD, selectionMode: SelectionMode.none, layoutMode: DetailsListLayoutMode.justified }))));
    };
    return DashboardApproved;
}(React.Component));
export default DashboardApproved;

//# sourceMappingURL=dashboardApproved.js.map
