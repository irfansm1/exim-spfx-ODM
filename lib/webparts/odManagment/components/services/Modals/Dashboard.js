...
var ODMDashboard = /** @class */ (function (_super) {
    __extends(ODMDashboard, _super);
    function ODMDashboard(props) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, EmployeeOps().getEmployee(this.props).then(function (brrResults) {
                            ...
                            ODMOps().getMyOD(_this.props, brrResults.Title).then(function (dataReceived) {
                                _this.setState({ data: dataReceived });
                                var datafilter = dataReceived.filter(function (user) { return user.ApproverResponse == "Pending"; });
                                _this.setState({ pendingOD: datafilter });
                                var datafilter1 = dataReceived.filter(function (user) { return user.ApproverResponse == "Approved"; });
                                _this.setState({ approvedOD: datafilter1 });
                                var datafilter2 = dataReceived.filter(function (user) { return user.ApproverResponse == "Rejected"; });
                                _this.setState({ rejectedOD: datafilter2 });
                            });
                            return brrResults;
                        })];
    ...
    ODMDashboard.prototype.componentDidMount = function () {
        this.getEmployeeData();
        // EmployeeOps().getUserProfile(this.props).then(results => {
        //     console.log(results);
        // });
    };
    ODMDashboard.prototype.render = function () {
        return (React.createElement("div", { className: "container-fluid" },
            React.createElement("div", { className: 'text-right' },
                React.createElement(Link, { className: "btn btn-primary", to: "/NewForm" },
                    React.createElement(Icon, { iconName: 'CircleAdditionSolid' }),
                    " Create New Request ")),
            React.createElement("div", { className: 'mt-n4 ' },
                React.createElement(Pivot, { linkSize: PivotLinkSize.normal, linkFormat: PivotLinkFormat.tabs },
                    React.createElement(PivotItem, { linkText: 'My Requests' },
                    ...
                    React.createElement(PivotItem, { linkText: 'Pending Requests' },
                    ...
                    React.createElement(PivotItem, { linkText: 'Rejected Requests' },
                        React.createElement(DashboardPending, { pendingOD: this.state.rejectedOD }))))));
    };
    return ODMDashboard;
}(React.Component));
export default ODMDashboard;
